...
RESULTS = f'{os.path.join(os.path.dirname(__file__))}/results'
FOLDER_WITH_FILE = f'{os.path.join(os.path.dirname(__file__))}/runs/track'
...
def download(file, filename):#загрузка файла
    ...
    FILE = f'{os.path.join(os.path.dirname(__file__))}/runs/track/weights_osnet_x0_25/{filename}'
    TXTFILE = f'{os.path.join(os.path.dirname(__file__))}/runs/track/weights_osnet_x0_25/tracks/{filename[:-4]}.txt'
    time.sleep(20)
